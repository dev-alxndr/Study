...
import io.alxndr.jpashop.domain.*;
...
public class InitDB {
    ...
    static class InitService {
        ...
        public void dbInit1() {
            Member member = createMember("USER A", "SEOUL", "123", "321312");
            em.persist(member);

            Book book1 = createBook("JPA 1 BOOK", 10000, 100);
            em.persist(book1);

            Book book2 = createBook("JPA 2 BOOK", 10000, 100);
            em.persist(book2);
        ...
        public void dbInit2() {
            Member member = createMember("USER B", "BUSAN", "123", "321312");
            em.persist(member);
