...
import io.alxndr.jpashop.repository.order.query.OrderQueryDto;
import io.alxndr.jpashop.repository.order.query.OrderQueryRepository;
import lombok.Data;
...
public class OrderApiController {
    ...
    public List<OrderDto> ordersV3_page(@RequestParam(value = "offset", defaultValue = "0") int offset,
        ...
        List<Order> allWithItem = orderRepository.findAllWithMemberAndDelivery(offset, limit);
        List<OrderDto> orders = allWithItem.stream()
                .map(o -> new OrderDto(o))
                .collect(Collectors.toList());
