...
import io.alxndr.springquerydsl.Team;
...
public class MemberRepositoryTest {
    ...
    @Test
    public void searchWithPageSimple() throws Exception {
        // given
        Team teamA = new Team("TEAM A");
        Team teamB = new Team("TEAM B");
        em.persist(teamA);
        ...
        Page<MemberTeamDto> result = memberRepository.searchWithPageSimple(condition, page);
        // then
